...
public class QualityRequirementsController {
    ...
    @Autowired
    QualityRequirementsService service;

    @GetMapping("/get")
    public Rsg get(int currentpage, int pagesize) {
        Page<QualityRequirements> page = new Page<>(currentpage, pagesize);
    ...
    @PostMapping
    public Rsg save(@RequestBody QualityRequirements qualityrequirements) {
        service.save(qualityrequirements);
    ...
    @PutMapping
    public Rsg update(@RequestBody QualityRequirements qualityrequirements) {
        service.updateById(qualityrequirements);
