...
@RestController
@RequestMapping("/RecruitStudents")
public class RecruitStudentsController {

    @Autowired
    RecruitStudentsService service;

    @GetMapping("/get")
    public Rsg get(int currentpage, int pagesize) {
        Page<RecruitStudents> page = new Page<>(currentpage, pagesize);
    ...
    @PostMapping
    public Rsg save(@RequestBody RecruitStudents recruitstudents) {
        service.save(recruitstudents);
    ...
    @PutMapping
    public Rsg update(@RequestBody RecruitStudents recruitstudents) {
        service.updateById(recruitstudents);
