...
public class ActivitiesController {
    ...
    public Rsg get(int currentpage, int pagesize) {
        Page<Activities> page = new Page<>(currentpage, pagesize);
    ...
    @PostMapping
    public Rsg save(@RequestBody Activities activities) {
    ...
    @PutMapping
    public Rsg update(@RequestBody Activities activities) {
        service.updateById(activities);
