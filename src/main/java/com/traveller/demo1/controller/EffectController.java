...
public class EffectController {
    ...
    public Rsg get(int currentpage, int pagesize) {
        Page<Effect> page = new Page<>(currentpage, pagesize);
    ...
    @PostMapping
    public Rsg save(@RequestBody Effect effect) {
        service.save(effect);
    ...
    @PutMapping
    public Rsg update(@RequestBody Effect effect) {
        service.updateById(effect);
