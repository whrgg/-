...
@RestController
@RequestMapping("/NaturalSubject")
public class NaturalSubjectController {

    @Autowired
    NaturalSubjectService service;

    @GetMapping("/get")
    public Rsg get(int currentpage, int pagesize) {
        Page<NaturalSubject> page = new Page<>(currentpage, pagesize);
    ...
    @PostMapping
    public Rsg save(@RequestBody NaturalSubject naturalsubject) {
        service.save(naturalsubject);
    ...
    @PutMapping
    public Rsg update(@RequestBody NaturalSubject naturalsubject) {
        service.updateById(naturalsubject);
