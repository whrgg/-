...
public class CapabilityClassController {

    @Autowired
    CapabilityClassService service;

    @GetMapping("/get")
    public Rsg get(int currentpage, int pagesize) {
        Page<CapabilityClass> page = new Page<>(currentpage, pagesize);
    ...
    @PostMapping
    public Rsg save(@RequestBody CapabilityClass capabilityclass) {
        service.save(capabilityclass);
    ...
    @PutMapping
    public Rsg update(@RequestBody CapabilityClass capabilityclass) {
        service.updateById(capabilityclass);
