...
public class ExplanationController {
    ...
    public Rsg get(int currentpage, int pagesize) {
        Page<Explanation> page = new Page<>(currentpage, pagesize);
    ...
    @PostMapping
    public Rsg save(@RequestBody Explanation explanation) {
        service.save(explanation);
    ...
    @PutMapping
    public Rsg update(@RequestBody Explanation explanation) {
        service.updateById(explanation);
